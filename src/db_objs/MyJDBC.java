...
public class MyJDBC {
    ...
    public static User validateLogin(String username, String password) {
        try {
            ...
            // parameter index referring to the iteration of the ? so 1 is the first ? and 2
            // is the second ?
    ...
    public static boolean transfer(User user, String transferredUsername, float transferAmount) {
        try {
            ...
            while (resultSet.next()) {
                ...
                transferredUser
                        .setCurrentBalance(transferredUser.getCurrentBalance().add(BigDecimal.valueOf(transferAmount)));
